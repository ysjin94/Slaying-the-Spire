...
cards = {
    #after burning pact
    'Carnage' : [2, True, Carnage],#12
    'Clash' : [0, True, Clash ], #13
    'Cleave' : [1, True, Cleave], #14
    'Clothsline' : [2, True, Clothsline], #15
    'Combust' :[1, True, Combust], #16
    'Corruption' : [3, False, Corruption], #17
    'Dark Embrace' : [2, False, Dark_Embradce], #18
    'Defend' : [1, False, Defend], #19
